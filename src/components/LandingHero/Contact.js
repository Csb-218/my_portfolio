        ...
        <div>
            <section className="bg-transparent backdrop-blur-sm dark:bg-gray-900">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-2xl ">
                    ...
                    <div className='flex  lg:justify-around flex-col items-center  w-full '>
                        
                        <div className='  w-full flex lg:flex-row lg:justify-evenly items-center flex-col' >
                            <a
                            ...
                            <a
                                ...
                                href='https://twitter.com/CsBhagwant'
                            >
                                <svg className="w-6 h-6  dark:text-white" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className='  flex lg:flex-row flex-col w-full '>
                            <div
                                className="powr-form-builder lg:w-1/2 w-full text-transparent lg:mt-32"
                                id="813ed9e4_1712147726">
                                .
                            </div>
                            <div
                                className="calendly-inline-widget lg:w-1/2 w-full text-transparent"
                                data-url="https://calendly.com/csb_2024/cs-bhagwant"
                                style={{
                                    minWidth: '320px',
                                    height: '1000px'
                                }}>
